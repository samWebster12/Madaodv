...
public:
   ...
   * \param origin the origin MAC address
   * \param originSeqNo the origin sequence number
   */
   RreqHeader (uint8_t flags = 0, uint8_t reserved = 0, uint8_t hopCount = 0,
              uint32_t requestID = 0, Mac48Address dst = Mac48Address (),
              uint32_t dstSeqNo = 0, Mac48Address origin = Mac48Address (),
...
private:
  ...
  Mac48Address    m_dst;            ///< Destination MAC Address
  uint32_t       m_dstSeqNo;       ///< Destination Sequence Number
  Mac48Address    m_origin;         ///< Originator MAC Address
...
public:
   ...
   */
  RrepHeader (uint8_t reserved = 0, uint8_t hopCount = 0, Mac48Address dst =
                Mac48Address (), uint32_t dstSeqNo = 0, Mac48Address origin =
                Mac48Address (), Time lifetime = MilliSeconds (0));
  /**
   * \brief Get the type ID.
   * \return the object TypeId
   */
   ...
   */
  void SetHello (Mac48Address src, uint32_t srcSeqNo, Time lifetime);
...
private:
  ...
  Mac48Address   m_dst;             ///< Destination MAC Address
  uint32_t      m_dstSeqNo;         ///< Destination Sequence Number
  Mac48Address     m_origin;        ///< Source MAC Address
...
public:
   ...
   */
  bool AddUnDestination (Mac48Address dst, uint32_t seqNo);
  /**
   ...
   */
  bool RemoveUnDestination (std::pair<Mac48Address, uint32_t> & un);
  /// Clear header
  void Clear ();
  /**
...
private:
  ...
  std::map<Mac48Address, uint32_t> m_unreachableDstSeqNo;
};
