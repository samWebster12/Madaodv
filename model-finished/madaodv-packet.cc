...
{
  return 43; //field lengths (44 bytes) - type length (1 byte)
}
...
RrepHeader::RrepHeader (uint8_t reserved, uint8_t hopCount, Ipv6Address dst,
...
{
  return 39; //Same as RREQ - RREQ ID
}
...
{
  return (3 + 20 * GetDestCount ()); //20 = 16 (Ipv6 Address) + 4 (Seqno)
}
